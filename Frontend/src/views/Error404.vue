    ...
    >
      ...
      <div class="py-16">
        <div class="text-center">
          <p class="text-sm font-semibold text-htl_rot uppercase tracking-wide">404 error</p>
          ...
          <div class="mt-6">
            <a
              @click="router.push('/')"
              class="text-base font-medium text-htl_rot hover:text-htl_rot cursor-pointer"
